      ...
      <div className="grid gap-px bg-white/5 border border-white/5 rounded-[2.5rem] overflow-hidden">
        {services.map((service, i) => (
          <motion.div
            ...
            className="group relative bg-background px-8  md:py-4 transition-all duration-500 hover:bg-white/[0.02]"
          >
            <div className="flex flex-col h-full relative z-10">
              ...
              <div className="flex justify-between items-start md:mb-12 mb-6">
                ...
                <div className="h-10 w-10 rounded-full border border-white/5 flex items-center justify-center group-hover:bg-primary group-hover:border-primary transition-all duration-300">
